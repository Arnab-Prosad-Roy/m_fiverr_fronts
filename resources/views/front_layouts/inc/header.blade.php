<nav class="navbar navbar-default navbar-mobile navbar-fixed white no-background bootsnav">
  <div class="container"> 
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index-2.html"> <img src="{{asset('front_asset/assets/img/logo-light.png')}}" class="logo logo-display" alt=""> 
      <img src="{{asset('front_asset/assets/img/logo.png')}}" class="logo logo-scrolled" alt=""> </a> 
	</div>
